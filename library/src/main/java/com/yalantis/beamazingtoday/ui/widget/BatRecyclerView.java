...
public class BatRecyclerView extends FrameLayout {
    ...
    public BatRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHeaderView=(BatHeaderView)findViewById(R.id.header_view);
        mBackground=(AppCompatImageView)findViewById(R.id.view);
    ...
    public void setCache(String path){
        mHeaderView.setPath(path);
    }

    public String getTackImg(){
       return mHeaderView.tackUri;
    }
    public void setTackImg(String s){
        mHeaderView.tackUri=s;
    }
